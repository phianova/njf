...
const page = () => {
  return (
    <div className="flex flex-col min-h-screen mx-auto mt-10 sm:mt-32 lg:mt-40 w-10/12">
        ...
        <div className="mt-10 md:mt-16 md:text-4xl">
        ...
        <p className="my-3">As part of my PhD research, I produce maps of these websites, some of which can be seen on the <a href="/graphs" className="underline decoration-dotted hover:font-bold hover:text-colour-link">Graphs</a> page of this website.</p>

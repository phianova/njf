...
const page = () => {
  return (
    <div className="flex flex-col min-h-screen mx-auto mt-10 sm:mt-32 lg:mt-40 md:text-3xl w-10/12">
      <Sidebar />
      <div className="sm:ml-48">
      <h1 className="text-colour-headings text-3xl md:text-5xl font-bold" id="full-data">Graphs</h1>
      ...
      <p>Explore the page to view how some of the websites in my research connect to each other. If you zoom in you can see the individual domain names that appear in my research.</p>

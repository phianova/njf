...
const Sidebar = () => {
  return (
    <div className="text-colour-link hidden sm:flex flex-col h-1/3 justify-around items-start p-5 fixed bg-colour-bg shadow-md rounded-r-xl right-0 text-2xl scroll-smooth">
